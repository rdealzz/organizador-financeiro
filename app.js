...
const REGRAS=[
  ...
  [/corte de cabelo|\bcabelo\b|barbearia|barbeiro|barbear|cabeleireir|cabelereir|\bsalao\b(?! de festa)|manicure|pedicure|\bunhas?\b|\bbarbas?\b|creme dental|pasta de dente|fio dental|esmalte|depilacao|sobrancelha|\bcilios\b|esteticista|\bestetica\b|maquiagem|cosmetic|perfum|\bspa\b|shampoo|xampu|condicionador|hidratante|sabonete|desodorante|progressiva|\bbotox\b/,'pessoal',2],
  [/\broupa(?! de (cama|mesa))|vestuario|jaqueta|casaco|moletom|camisa|camiseta|\bblusas?\b|\bcalcas?\b|calcado|bermuda|short|vestido|\bsaias?\b|pijama|cueca|calcinha|sutia|\bmeias\b|sapato|\btenis\b|sandalia|chinelo|\bbotas?\b|sapatilha|havaianas|sunga|biquini|\bbones?\b|\bcintos?\b|oculos de sol|renner|riachuelo|c&a|\bhering\b|pernambucanas|shein|\bzara\b|centauro|netshoes|decathlon|\bnike\b|adidas|\bpuma\b|olympikus|mizuno|alpinestars/,'roupa',3],
